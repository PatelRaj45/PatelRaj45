...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=PatelRaj45&label=Profile%20Views&color=0e75b6&style=for-the-badge" />
</p>
...
const raj = {
  ...
  cgpa        : "9.12",
  stack       : ["PyTorch", "HuggingFace", "Scikit-learn", "Gradio"],
  interests   : ["AI", "Deep Learning", "Generative AI", "RAG"],
  coding      : "350+ DSA Problems Solved",
  mindset     : "Build real systems, not just projects 🚀",
};
```
...
- 🧠 Built deep learning models for image classification & chatbots
- 🔁 Designed end-to-end ML pipelines (data → training → inference)
- ⚡ Optimized models for real-time inference performance

🔗 [View Internship Certificate](https://drive.google.com/file/d/1OpbSs1BYSbKxRJOw3rGw37dj52MxKksp/view)
